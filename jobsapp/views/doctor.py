...
from jobsapp.decorators import user_is_doctor
...
class DashboardView(ListView):
    model = Job
    template_name = 'jobs/doctor/dashboard.html'
...
class ApplicantPerJobView(ListView):
    model = Applicant
    template_name = 'jobs/doctor/applicants.html'
...
class JobCreateView(CreateView):
    ...
    success_url = reverse_lazy('jobs:doctor-dashboard')
...
class ApplicantsListView(ListView):
    model = Applicant
    template_name = 'jobs/doctor/all-applicants.html'
    context_object_name = 'applicants'
...
def filled(request, job_id=None):
    ...
    job.filled = True
    job.save()
    return HttpResponseRedirect(reverse_lazy('jobs:doctor-dashboard'))
